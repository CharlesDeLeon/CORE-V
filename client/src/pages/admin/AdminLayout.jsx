    ...
    <div style={styles.root}>
      ...
      <div style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          <div
            style={{ ...styles.navItem, ...(isActive('/admin/dashboard') ? styles.navItemActive : {}) }}
            onClick={() => navigate('/admin/dashboard')}
          >
            Dashboard
          </div>
          <div
            style={{ ...styles.navItem, ...(isActive('/admin/auditTrail') ? styles.navItemActive : {}) }}
            onClick={() => navigate('/admin/auditTrail')}
          >
            Audit Trail
          </div>
          <div
